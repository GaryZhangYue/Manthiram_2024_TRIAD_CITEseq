...
for (i in c('FYJ', 'SRN', 'VR','GPG','HMM','JG', 'MMA', 'VKM','NYP')){
...
group = ifelse(c('FYJ', 'SRN', 'VR','GPG','HMM','JG', 'MMA', 'VKM','NYP') %in% c('FYJ', 'SRN', 'VR'), 'control', 'trisomy8')
combined <- combineTCR(contig_list, 
                        samples = c('FYJ', 'SRN', 'VR','GPG','HMM','JG', 'MMA', 'VKM','NYP'), 
                        cells ="T-AB")
...
for (sample in c('GPG','HMM','JG', 'MMA', 'VKM','NYP')){
