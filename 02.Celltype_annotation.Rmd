...
cluster_frequency.curated_clusters2$group = ifelse(cluster_frequency.curated_clusters2$orig.ident %in% c('FYJ', 'SRN', 'VR'), 'control', 'trisomy8')
cluster_frequency.curated_clusters2$orig.ident = factor(cluster_frequency.curated_clusters2$orig.ident, levels = c('FYJ', 'SRN', 'VR',
                                                                                                                   'GPG','HMM','JG', 'MMA', 'VKM','NYP'))
...
cluster_frequency.curated_clusters$group = ifelse(cluster_frequency.curated_clusters$orig.ident %in% c('FYJ', 'SRN', 'VR'), 'control', 'trisomy8')
cluster_frequency.curated_clusters$orig.ident = factor(cluster_frequency.curated_clusters$orig.ident, levels = c('FYJ', 'SRN', 'VR',
                                                                                                                 'GPG','HMM','JG', 'MMA', 'VKM','NYP'))
...
cluster_frequency.predicted.celltype.l1$group = ifelse(cluster_frequency.predicted.celltype.l1$orig.ident %in% c('FYJ', 'SRN', 'VR'), 'control', 'trisomy8')
cluster_frequency.predicted.celltype.l1$orig.ident = factor(cluster_frequency.predicted.celltype.l1$orig.ident, levels = c('FYJ', 'SRN', 'VR',
                                                                                                                           'GPG','HMM','JG', 'MMA', 'VKM','NYP'))
