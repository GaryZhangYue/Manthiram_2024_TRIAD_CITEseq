...
sum(tsct.summary2$count[tsct.summary2$orig.ident == 'GPG']) == nrow(pbmc@meta.data[pbmc@meta.data$orig.ident=='GPG',]) # matched
tsct.summary3 <- pivot_wider(select(tsct.summary2, - relative_frequenc), names_from = trisomy, values_from = count, values_fill = 0) %>%
  subset(!(orig.ident %in% c('FYJ', 'SRN', 'VR')))
```
...
ggplot(data = tsct.summary2[!(tsct.summary2$orig.ident %in% c('FYJ','SRN','VR')),], mapping = aes(x = curated_clusters4, y = `count`,fill = trisomy)) +
...
ggplot(data = tsct.summary2[!(tsct.summary2$orig.ident %in% c('FYJ','SRN','VR')),], mapping = aes(x = curated_clusters4, y = `relative_frequenc`,fill = trisomy)) +
  facet_grid(.~orig.ident) +
  geom_bar(stat="identity",color = 'black') +
  theme_classic() +
  theme(legend.title = element_blank(),
...
sum(tsct.mld.summary2$count[tsct.mld.summary2$orig.ident == 'GPG']) == nrow(pbmc@meta.data[pbmc@meta.data$orig.ident=='GPG',]) # matched
sum(tsct.mld.summary2$count[tsct.mld.summary2$orig.ident == 'GPG' & !(is.na(tsct.mld.summary2$myeloid_Clusters))]) == nrow(pbmc.mld2@meta.data[pbmc.mld2@meta.data$orig.ident=='GPG',]) # matched
...
ggplot(data = tsct.mld.summary2[!(tsct.mld.summary2$orig.ident %in% c('FYJ','SRN','VR')),], mapping = aes(x = myeloid_Clusters, y = `count`,fill = trisomy)) +
  facet_grid(.~orig.ident) +
  geom_bar(stat="identity",color = 'black') +
  theme_classic() +
  theme(legend.title = element_blank(),
...
ggplot(data = tsct.mld.summary2[!(tsct.mld.summary2$orig.ident %in% c('FYJ','SRN','VR')),], mapping = aes(x = orig.ident, y = `count`,fill = trisomy)) +
...
ggplot(data = tsct.mld.summary2[!(tsct.mld.summary2$orig.ident %in% c('FYJ','SRN','VR')),], mapping = aes(x = myeloid_Clusters, y = `relative_frequenc`,fill = trisomy)) +
  facet_grid(.~orig.ident) +
  geom_bar(stat="identity",color = 'black') +
  theme_classic() +
  theme(legend.title = element_blank(),
