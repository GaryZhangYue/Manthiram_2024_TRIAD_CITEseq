...
pbmc.mld@meta.data$orig.ident = factor(pbmc.mld@meta.data$orig.ident, levels = c('FYJ', 'SRN', 'VR','GPG','HMM','JG', 'MMA', 'VKM','NYP'))
...
2. On the group-level comparison, patients have more cells in cluster 1, especially in HMM, JG and NYP.
3. GPG has an distinctly dense cluster 2, JG has substantially more cells in clusetrs 1 and 4, MMA has a distinctly dense cluster 3
